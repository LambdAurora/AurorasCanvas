...
public final class AurorasDecoDataUpper {
	...
	public static void fixNbt(CompoundTag nbt, FixSource source) {
		...
		result.ifSuccess(data -> nbt.put("canvas", data));
		result.ifError(error -> LOGGER.info("Failed to datafix canvas {}: {}", source, error));
	...
	public static void fixGlassNbt(CompoundTag nbt, FixSource source) {
		...
		result.ifSuccess(data -> nbt.put("canvas", data));
		result.ifError(error -> LOGGER.info("Failed to datafix glass canvas {}: {}", source, error));
